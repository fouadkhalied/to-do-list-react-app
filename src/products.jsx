    ...
    return (
      ...
      <tbody>
              ...
              <td onClick={
                ()=>{
                  if(colIndex == 14) {
                    ...
                    const defs = prompt('قطاعي المعدل');
                    if(defs === "" || defs === null)
                      alert("المدخل غير صالح")
                    else
                      toedit(rowIndex , colIndex - 1 , defs);
                    ...
                    const defs = prompt('شركات المعدل');
                    if(defs === "" || defs === null)
                      alert("المدخل غير صالح")
                    else
                      toedit(rowIndex , colIndex - 1 , defs);
                    ...
                    const defs = prompt('توزيع المعدل');
                    if(defs === "" || defs === null)
                      alert("المدخل غير صالح")
                    else
                      toedit(rowIndex , colIndex - 1 , defs);
                    ...
                    const defs = prompt('طريقه التقديم المعدل');
                    if(defs === "" || defs === null)
                      alert("المدخل غير صالح")
                    else
                      toedit(rowIndex , colIndex - 1 , defs);
        ...
        <div className='my-input_product_costs'>
            ...
            <div className='my-input-element'>
                <input ref={inputref2} className='input3' placeholder='قطاعي' />
            </div>
            <div className='my-input-element'>
                <input ref={inputref3} className='input4' placeholder='شركات'/>
            </div>
            <div className='my-input-element'>
                <input ref={inputref4} className='input5' placeholder='جمله' />
            </div>
            <div className='my-input-element'>
                <input ref={inputref5} className='input5' placeholder='توزيع' />
            </div>
            <div className='my-input-element'>
                <input ref={inputref6} className='input5' placeholder='طريقه التقديم' />
            </div>
